...
// Test mixed supported and unsupported functions - should reject if any function is unsupported
...
TEST_F(CudfAggregationSelectionTest, comprehensiveTypeSupportValidation) {
  ...
  auto sumBigintExpr = std::make_shared<core::CallTypedExpr>(
      BIGINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(BIGINT(), "c0")}, "sum");
  ...
  auto sumDoubleExpr = std::make_shared<core::CallTypedExpr>(
      DOUBLE(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(DOUBLE(), "c3")}, "sum");

  // COUNT signatures
  auto countTinyintExpr = std::make_shared<core::CallTypedExpr>(
      BIGINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(TINYINT(), "c0")}, "count");
  auto countSmallintExpr = std::make_shared<core::CallTypedExpr>(
      BIGINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(SMALLINT(), "c1")}, "count");
  auto countIntegerExpr = std::make_shared<core::CallTypedExpr>(
      BIGINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(INTEGER(), "c2")}, "count");
  auto countBigintExpr = std::make_shared<core::CallTypedExpr>(
      BIGINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(BIGINT(), "c0")}, "count");
  auto countRealExpr = std::make_shared<core::CallTypedExpr>(
      BIGINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(REAL(), "c4")}, "count");
  auto countDoubleExpr = std::make_shared<core::CallTypedExpr>(
      BIGINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(DOUBLE(), "c3")}, "count");
  ...
  auto countBooleanExpr = std::make_shared<core::CallTypedExpr>(
      BIGINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(BOOLEAN(), "c7")}, "count");
  ...
  auto minTinyintExpr = std::make_shared<core::CallTypedExpr>(
      TINYINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(TINYINT(), "c0")}, "min");
  auto minSmallintExpr = std::make_shared<core::CallTypedExpr>(
      SMALLINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(SMALLINT(), "c1")}, "min");
  auto minIntegerExpr = std::make_shared<core::CallTypedExpr>(
      INTEGER(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(INTEGER(), "c2")}, "min");
  auto minBigintExpr = std::make_shared<core::CallTypedExpr>(
      BIGINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(BIGINT(), "c0")}, "min");
  auto minRealExpr = std::make_shared<core::CallTypedExpr>(
      REAL(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(REAL(), "c4")}, "min");
  auto minDoubleExpr = std::make_shared<core::CallTypedExpr>(
      DOUBLE(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(DOUBLE(), "c3")}, "min");

  // MAX signatures
  auto maxTinyintExpr = std::make_shared<core::CallTypedExpr>(
      TINYINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(TINYINT(), "c0")}, "max");
  auto maxSmallintExpr = std::make_shared<core::CallTypedExpr>(
      SMALLINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(SMALLINT(), "c1")}, "max");
  auto maxIntegerExpr = std::make_shared<core::CallTypedExpr>(
      INTEGER(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(INTEGER(), "c2")}, "max");
  auto maxBigintExpr = std::make_shared<core::CallTypedExpr>(
      BIGINT(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(BIGINT(), "c0")}, "max");
  auto maxRealExpr = std::make_shared<core::CallTypedExpr>(
      REAL(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(REAL(), "c4")}, "max");
  auto maxDoubleExpr = std::make_shared<core::CallTypedExpr>(
      DOUBLE(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(DOUBLE(), "c3")}, "max");

  // AVG signatures
  auto avgSmallintExpr = std::make_shared<core::CallTypedExpr>(
      DOUBLE(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(SMALLINT(), "c1")}, "avg");
  ...
  auto avgBigintExpr = std::make_shared<core::CallTypedExpr>(
      DOUBLE(), std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(BIGINT(), "c0")}, "avg");
...
TEST_F(CudfAggregationSelectionTest, invalidTypeCombinationsRejected) {
  ...
  ASSERT_FALSE(canBeEvaluatedByCudf(minVarcharExpr));
  ASSERT_FALSE(canBeEvaluatedByCudf(maxBooleanExpr));
}
