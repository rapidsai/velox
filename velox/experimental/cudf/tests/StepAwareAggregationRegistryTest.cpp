...
TEST_F(StepAwareAggregationRegistryTest, allFunctionsAreRegistered) {
  ...
  EXPECT_TRUE(registry.find("avg") != registry.end()) << "avg function should be registered";
  EXPECT_TRUE(registry.find("sum") != registry.end()) << "sum function should be registered";
  EXPECT_TRUE(registry.find("count") != registry.end()) << "count function should be registered";
  EXPECT_TRUE(registry.find("min") != registry.end()) << "min function should be registered";
  EXPECT_TRUE(registry.find("max") != registry.end()) << "max function should be registered";
}
...
TEST_F(StepAwareAggregationRegistryTest, allStepsAreRegisteredForAvg) {
  ...
  EXPECT_TRUE(avgSteps.find(core::AggregationNode::Step::kSingle) != avgSteps.end()) << "avg single step should be registered";
  EXPECT_TRUE(avgSteps.find(core::AggregationNode::Step::kPartial) != avgSteps.end()) << "avg partial step should be registered";
  EXPECT_TRUE(avgSteps.find(core::AggregationNode::Step::kFinal) != avgSteps.end()) << "avg final step should be registered";
  EXPECT_TRUE(avgSteps.find(core::AggregationNode::Step::kIntermediate) != avgSteps.end()) << "avg intermediate step should be registered";
}
...
TEST_F(StepAwareAggregationRegistryTest, avgHasSignaturesForAllSteps) {
  ...
  EXPECT_FALSE(intermediateSigs.empty()) << "Intermediate step should have signatures";
}
...
TEST_F(StepAwareAggregationRegistryTest, avgSingleStepValidation) {
  ...
  EXPECT_TRUE(singleStepSupported) << "Single step avg(DOUBLE) should be supported";
}
...
TEST_F(StepAwareAggregationRegistryTest, avgPartialStepValidation) {
  ...
  EXPECT_TRUE(partialStepSupported) << "Partial step avg(DOUBLE) should be supported";
}
...
TEST_F(StepAwareAggregationRegistryTest, avgFinalStepValidation) {
  ...
  auto avgFinalCall = std::make_shared<core::CallTypedExpr>(
      DOUBLE(),
      std::vector<core::TypedExprPtr>{
          std::make_shared<core::FieldAccessTypedExpr>(rowType, "intermediate")
      },
      "avg");
  ...
  EXPECT_TRUE(finalStepSupported) << "Final step avg(ROW(DOUBLE,BIGINT)) should be supported";
}
...
TEST_F(StepAwareAggregationRegistryTest, sumStepConsistency) {
  ...
  bool sumSingle = canAggregationBeEvaluatedByCudf(*sumCall, core::AggregationNode::Step::kSingle, {DOUBLE()}, queryCtx_.get());
  bool sumPartial = canAggregationBeEvaluatedByCudf(*sumCall, core::AggregationNode::Step::kPartial, {DOUBLE()}, queryCtx_.get());
  bool sumFinal = canAggregationBeEvaluatedByCudf(*sumCall, core::AggregationNode::Step::kFinal, {DOUBLE()}, queryCtx_.get());
  bool sumIntermediate = canAggregationBeEvaluatedByCudf(*sumCall, core::AggregationNode::Step::kIntermediate, {DOUBLE()}, queryCtx_.get());
...
TEST_F(StepAwareAggregationRegistryTest, countStepConsistency) {
  ...
  bool countSingle = canAggregationBeEvaluatedByCudf(*countCall, core::AggregationNode::Step::kSingle, {DOUBLE()}, queryCtx_.get());
  bool countPartial = canAggregationBeEvaluatedByCudf(*countCall, core::AggregationNode::Step::kPartial, {DOUBLE()}, queryCtx_.get());
  bool countFinal = canAggregationBeEvaluatedByCudf(*countCall, core::AggregationNode::Step::kFinal, {DOUBLE()}, queryCtx_.get());
  bool countIntermediate = canAggregationBeEvaluatedByCudf(*countCall, core::AggregationNode::Step::kIntermediate, {DOUBLE()}, queryCtx_.get());
  ...
  EXPECT_TRUE(countIntermediate) << "Count intermediate step should be supported";
}
...
TEST_F(StepAwareAggregationRegistryTest, minStepConsistency) {
  ...
  bool minSingle = canAggregationBeEvaluatedByCudf(*minCall, core::AggregationNode::Step::kSingle, {DOUBLE()}, queryCtx_.get());
  bool minPartial = canAggregationBeEvaluatedByCudf(*minCall, core::AggregationNode::Step::kPartial, {DOUBLE()}, queryCtx_.get());
  bool minFinal = canAggregationBeEvaluatedByCudf(*minCall, core::AggregationNode::Step::kFinal, {DOUBLE()}, queryCtx_.get());
  bool minIntermediate = canAggregationBeEvaluatedByCudf(*minCall, core::AggregationNode::Step::kIntermediate, {DOUBLE()}, queryCtx_.get());
...
TEST_F(StepAwareAggregationRegistryTest, maxStepConsistency) {
  ...
  bool maxSingle = canAggregationBeEvaluatedByCudf(*maxCall, core::AggregationNode::Step::kSingle, {DOUBLE()}, queryCtx_.get());
  bool maxPartial = canAggregationBeEvaluatedByCudf(*maxCall, core::AggregationNode::Step::kPartial, {DOUBLE()}, queryCtx_.get());
  bool maxFinal = canAggregationBeEvaluatedByCudf(*maxCall, core::AggregationNode::Step::kFinal, {DOUBLE()}, queryCtx_.get());
  bool maxIntermediate = canAggregationBeEvaluatedByCudf(*maxCall, core::AggregationNode::Step::kIntermediate, {DOUBLE()}, queryCtx_.get());
